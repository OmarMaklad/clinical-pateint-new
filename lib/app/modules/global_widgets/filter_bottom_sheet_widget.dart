          ...
          Padding(
            ...
            child: ListView(
              ...
              children: [
                ...
                ExpansionTile(
                  title: Text("Emirate".tr, style: Get.textTheme.bodyMedium),
                  children: List.generate(controller.emirates.length, (index) {
                    var _emirate = controller.emirates.elementAt(index);
                    return Obx(() {
                      return CheckboxListTile(
                        controlAffinity: ListTileControlAffinity.trailing,
                        value: controller.selectedEmirates.contains(_emirate),
                        onChanged: (value) {
                          controller.toggleEmirate(value!, _emirate);
                        },
                        title: Text(
                          _emirate,
                          style: Get.textTheme.bodyLarge,
                ...
                ExpansionTile(
                  title: Text("Insurances".tr, style: Get.textTheme.bodyMedium),
                  children: List.generate(Get.find<HomeController>().insurances.length, (index) {
                    var _insurance = Get.find<HomeController>().insurances.elementAt(index);
                    return Obx(() {
                      return CheckboxListTile(
                        controlAffinity: ListTileControlAffinity.trailing,
                        value: controller.selectedInsurances.contains('${_insurance.id}'),
                        onChanged: (value) {
                          controller.toggleInsurance(value!, '${_insurance.id}');
                        },
                        title: Text(
                          '${_insurance.name}',
                          style: Get.textTheme.bodyLarge,
