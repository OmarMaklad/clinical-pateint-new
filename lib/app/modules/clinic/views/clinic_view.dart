...
class ClinicView extends GetView<ClinicController> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ClinicTilWidget(
                          ...
                          content: Ui.applyHtml(_clinic.description ?? '',
                        ...
                        ClinicTilWidget(
                          horizontalPadding: 0,
                          title: Text("Featured Doctors".tr,
                                  style: Get.textTheme.titleSmall)
                          ...
                          actions: [
                            InkWell(
                              onTap: () {
                                Get.toNamed(Routes.CLINIC_DOCTORS,
                                    arguments: _clinic);
                              },
                        ...
                        ClinicTilWidget(
                          ...
                          content: Column(
                            children: [
                              ...
                              Wrap(
                                children:
                                    Ui.getStarsList(_clinic.rate, size: 32),
                              ),
                              Text(
                                "Reviews (%s)"
          ...
          Wrap(
            ...
            children: [
              MaterialButton(
                onPressed: () {
                  launchUrlString(
                      "tel:${controller.clinic.value.mobileNumber}");
                },
                height: 44,
                minWidth: 44,
                padding: EdgeInsets.zero,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Location".tr,
                                style: Get.textTheme.titleSmall),
                            SizedBox(height: 5),
                            Text(controller.clinic.value.address!.address,
                                style: Get.textTheme.bodySmall),
                          ],
                        ),
                      ),
  ...
  Widget buildCarouselSlider(Clinic _clinic) {
    return Stack(
      children: [
        CarouselSlider(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                "Appointments (%s)"
                    .trArgs([_clinic.total_appointments.toString()]),
                style: Get.textTheme.bodySmall,
              ),
            ],
          ),
