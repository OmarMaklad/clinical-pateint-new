      ...
      child: ListView(
        children: [
          ...
          DrawerLinkWidget(
            ...
            text: "Favourite",
            onTap: (e) async {
              await Get.toNamed(Routes.FAVORITES);
            },
          ),
          DrawerLinkWidget(
          ...
          //   text: "Wallets",
          //   onTap: (e) async {
          //     await Get.toNamed(page)(Routes.WALLETS);
          //   },
          // ),
          DrawerLinkWidget(
          ...
          DrawerLinkWidget(
            ...
            text: "Languages",
            onTap: (e) async {
              await Get.toNamed(Routes.SETTINGS_LANGUAGE);
            },
          ),
          DrawerLinkWidget(
            ...
            onTap: (e) async {
              await Get.toNamed(Routes.SETTINGS_THEME_MODE);
            },
          ),
          ListTile(
            dense: true,
