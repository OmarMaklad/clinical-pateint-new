                      ...
                      Container(
                        ...
                        decoration: new BoxDecoration(
                          ...
                          gradient: new LinearGradient(
                              colors: [
                                controller.speciality.value.color
                                    .withOpacity(1),
                                controller.speciality.value.color
                                    .withOpacity(0.2)
                              ],
                        ...
                        child: (controller.speciality.value.image.url
                                .toLowerCase()
                                .endsWith('.svg')
                            ? SvgPicture.network(
                ...
                children: [
                  Container(
                    ...
                    child: ListView(
                        ...
                        children: List.generate(SpecialityFilter.values.length,
                            (index) {
                          var _filter =
                              SpecialityFilter.values.elementAt(index);
                          return Obx(() {
                            return Padding(
                              padding:
                              ...
                              child: RawChip(
                                ...
                                onSelected: (bool value) {
                                  ...
                                  controller.loadDoctorsOfSpeciality(
                                      controller.speciality.value.id,
