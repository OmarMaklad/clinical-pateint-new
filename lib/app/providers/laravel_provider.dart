...
class LaravelApiClient extends GetxService with ApiClient {
  ...
  Future<List<Insurance>> getInsurances() async {
    ...
    Uri _uri =
        getApiBaseUri("insurances").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<Insurance>((obj) => Insurance.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<Doctor>> getRecommendedDoctors() async {
    ...
    // }
    Uri _uri =
        getApiBaseUri("doctors").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']
  ...
  Future<List<Doctor>> getAllDoctorsWithPagination(
      String specialityId, int page) async {
    final _address = Get.find<SettingsService>().address.value;
    var _queryParameters = {
  ...
  Future<List<Doctor>> searchDoctors(
    ...
    var _queryParameters = {
      ...
      'searchJoin': 'and',
      'emirate': '${emirates.join(',')}',
      'insurance': '${insurances.join(',')}',
    };
    // if (!_address.isUnknown()) {
    //   _queryParameters['myLat'] = _address.latitude.toString();
    //   _queryParameters['myLon'] = _address.longitude.toString();
  ...
  Future<Favorite> addFavoriteDoctor(Favorite favorite) async {
    if (!authService.isAuth) {
      throw new Exception(
          "You must have an account to be able to add doctors to favorite".tr +
              "[ addFavoriteDoctor() ]");
    }
    var _queryParameters = {
      'api_token': authService.apiToken,
  ...
  Future sendMessage () async {
    ...
    Uri _uri =
    getApiBaseUri("chat/send-message").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.postUri(
      _uri,
      data: {
  ...
  Future getALLMessages () async {
    ...
    Uri _uri =
    getApiBaseUri("chat/38/message").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(
      _uri,
      options: optionsNetwork,
  ...
  Future<Doctor> getDoctor(String id) async {
    ...
    Uri _uri =
        getApiBaseUri("doctors/$id").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<Clinic> getClinic(String clinicId) async {
    ...
    Uri _uri = getApiBaseUri("clinics/$clinicId")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<List<Clinic>> getRecommendedClinics() async {
    ...
    if (response.data['success'] == true) {
      return response.data['data']
          .map<Clinic>((obj) => Clinic.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<Clinic>> getNearClinics(LatLng latLng, LatLng areaLatLng) async {
    var _queryParameters = {
      'only':
          'id;name;has_media;media;total_reviews;rate;address;distance;available',
      'with': 'address',
      'limit': '6',
    };
    ...
    Uri _uri =
        getApiBaseUri("clinics").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']
  ...
  Future<List<Review>> getClinicReviews(String clinicId) async {
    var _queryParameters = {
      'with': 'clinicReviews;clinicReviews.user',
      'only':
          'clinicReviews.id;clinicReviews.review;clinicReviews.rate;clinicReviews.user;'
    };
    Uri _uri = getApiBaseUri("clinics/$clinicId")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']['clinic_reviews']
  ...
  Future incrementViews(String clinicId) async {
    var _queryParameters = {
      'api_token': authService.apiToken,
    };
    Uri _uri = getApiBaseUri("clinics/$clinicId/view")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.postUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
      print(response.data);
    } else {
      throw new Exception(response.data['message']);
  ...
  Future<List<Doctor>> getClinicFeaturedDoctors(
      String clinicId, int page) async {
    var _queryParameters = {
      'with': 'clinic;clinic.address;specialities',
      'search': 'clinic_id:$clinicId',
      'searchFields': 'clinic_id:=',
  ...
  Future<List<Doctor>> getClinicPopularDoctors(
      String clinicId, int page) async {
  ...
  Future<List<Doctor>> getClinicAvailableDoctors(
      String clinicId, int page) async {
    var _queryParameters = {
      'with': 'clinic;clinic.address;specialities',
      'search': 'clinic_id:$clinicId',
  ...
  Future<List<Doctor>> getClinicMostRatedDoctors(
      String clinicId, int page) async {
    var _queryParameters = {
  ...
  Future<List<Review>> getDoctorReviews(String doctorId) async {
    ...
    Uri _uri = getApiBaseUri("doctor_reviews")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
  ...
  Future<List<Doctor>> getMostRatedDoctors(
      String specialityId, int page) async {
    final _address = Get.find<SettingsService>().address.value;
    var _queryParameters = {
      //'only': 'id;name;price;discount_price;price_unit;duration;has_media;total_reviews;rate',
  ...
  Future<List<Speciality>> getAllSpecialities() async {
    ...
    Uri _uri = getApiBaseUri("specialities")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<Speciality>((obj) => Speciality.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<Appointment>> getAppointments(String statusId, int page) async {
    ...
    Uri _uri = getApiBaseUri("appointments")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<List<AppointmentStatus>> getAppointmentStatuses() async {
    ...
    Uri _uri = getApiBaseUri("appointment_statuses")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsCache);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<AppointmentStatus>((obj) => AppointmentStatus.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<Appointment> getAppointment(String appointmentId) async {
    var _queryParameters = {
      'with':
          'appointmentStatus;user;payment;payment.paymentMethod;payment.paymentStatus',
      'api_token': authService.apiToken,
    };
    Uri _uri = getApiBaseUri("appointments/${appointmentId}")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<Coupon> validateCoupon(Appointment appointment) async {
    var _queryParameters = {
      ...
      'specialities_id':
          appointment.doctor?.specialities?.map((e) => e.id)?.join(",") ?? '',
    };
    Uri _uri =
  ...
  Future<Appointment> updateAppointment(Appointment appointment) async {
    ...
    Uri _uri = getApiBaseUri("appointments/${appointment.id}")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.putUri(_uri,
        data: appointment.toJson(), options: optionsNetwork);
    if (response.data['success'] == true) {
      return Appointment.fromJson(response.data['data']);
    } else {
      throw new Exception(response.data['message']);
  ...
  Future<Review> addClinicReview(Review review) async {
    ...
    Uri _uri = getApiBaseUri("clinic_reviews")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.postUri(_uri,
        data: review.toJson(), options: optionsNetwork);
  ...
  Future<Payment> createPayment(Appointment _appointment) async {
    ...
    Get.log(_uri.toString());
    var response = await httpClient.postUri(_uri,
        data: _appointment.toJson(), options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<Payment> createWalletPayment(
      Appointment _appointment, Wallet _wallet) async {
    if (!authService.isAuth) {
      throw new Exception(
          "You don't have the permission to access to this area!".tr +
              "[ createPayment() ]");
  ...
  Future<List> getAvailabilityHours(String doctorId, DateTime date) async {
    ...
    Uri _uri = getApiBaseUri("availability_hours/$doctorId")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<List<Patient>> getAllClinicPatientsWithPagination(
      String clinicID, int page) async {
    final _address = Get.find<SettingsService>().address.value;
    var _queryParameters = {
    ...
    // }
    Uri _uri =
        getApiBaseUri("patients").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<Patient>((obj) => Patient.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<Patient> getPatient(String id) async {
    ...
    Uri _uri = getApiBaseUri("patients/$id")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
  ...
  Future<Patient> updatePatient(Patient patient) async {
    ...
    Uri _uri = getApiBaseUri("patients/${patient.id}")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.postUri(
      _uri,
  ...
  Future<List<Blog>> getAllBlogsWithPagination() async {
    var _queryParameters = {
      'page': '1',
    };
    Uri _uri =
        getApiBaseUri("articles").replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
      return response.data['data']['data']
          .map<Blog>((obj) => Blog.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<Blog>> getBlogsById(int categoryId) async {
    var _queryParameters = {
  ...
  Future<List<BlogCategory>> getAllCategories() async {
    var _queryParameters = {
      'page': '1',
    };
    Uri _uri = getApiBaseUri("articles-categories")
        .replace(queryParameters: _queryParameters);
    Get.log(_uri.toString());
    var response = await httpClient.getUri(_uri, options: optionsNetwork);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<BlogCategory>((obj) => BlogCategory.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
