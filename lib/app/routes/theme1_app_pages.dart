import 'package:doctors_appointments/app/modules/blogs/views/blogs_view.dart';
...
import '../modules/blogs/bindings/blog_bindings.dart';
import '../modules/blogs/views/blog_details_view.dart';
...
import '../modules/introduction/bindings/intro_binding.dart';
import '../modules/introduction/views/intro_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.INTRODUCTION, page: () => IntroView(),binding: IntroBinding()),
    ...
    GetPage(name: Routes.BLOGS, page: () => BlogsView(), binding: BlogBindings(),),
    GetPage(name: Routes.BLOGS_DETAILS, page: () => BlogDetailsView()),
