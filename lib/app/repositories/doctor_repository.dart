...
class DoctorRepository {
  ...
  Future<List<Doctor>> getAllWithPagination(String specialityId,
      {int page = 1}) {
    return _laravelApiClient.getAllDoctorsWithPagination(specialityId, page);
  }

  Future<List<Doctor>> search(String? keywords, List<String> specialities,
      {int page = 1, List<String> emirates = const [], List<String> insurances = const []}) {
    return _laravelApiClient.searchDoctors(
        keywords, specialities, emirates, insurances,page);
  }
  ...
  Future<List<Insurance>> getInsurances() {
    return _laravelApiClient.getInsurances();
  }
