...
class SpecialityListItemWidget extends StatelessWidget {
  ...
  SpecialityListItemWidget(
      {Key? key, required this.speciality, this.heroTag, this.expanded})
      : super(key: key);
    ...
    return Container(
      ...
      decoration: Ui.getBoxDecoration(
          ...
          gradient: new LinearGradient(
              colors: [
                speciality.color.withOpacity(0.6),
                speciality.color.withOpacity(0.1)
              ],
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children:
              List.generate(speciality.subSpecialities?.length ?? 0, (index) {
