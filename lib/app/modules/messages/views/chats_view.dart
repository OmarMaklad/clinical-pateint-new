...
class ChatsView extends GetView<MessagesController> {
  ...
  Widget build(BuildContext context) {
    ...
    final  _database = FirebaseDatabase.instanceFor(app: firebaseApp,databaseURL: 'https://medialapp-98ea4-default-rtdb.firebaseio.com/');
    DatabaseReference starCountRef = _database.ref('doctor_38_patient_1');
    return Scaffold(
      appBar: AppBar(
      ...
      body: Column(
        ...
        children: <Widget>[
          StreamBuilder<Object>(
            stream: starCountRef.limitToLast(1).onValue,

            builder: (context, snapshot) {
              var data ;
              data = snapshot.data!;
              starCountRef.limitToLast(1).onValue.listen((event) {
