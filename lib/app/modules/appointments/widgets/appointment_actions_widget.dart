...
class AppointmentActionsWidget extends GetView<AppointmentController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (_appointment.value.status!.order ==
        ...
        return Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            if (_appointment.value.status!.order ==
                ...
                _appointment.value.payment == null)
              Expanded(
            ...
            if (_appointment.value.status!.order ==
              ...
              Expanded(
                child: Text(
                  "Waiting for Clinic to start the appointment".tr,
                  textAlign: TextAlign.center,
            ...
            if (_appointment.value.status!.order ==
              ...
              Expanded(
                child: Text(
                  "Waiting for Clinic to finish the appointment".tr,
                  textAlign: TextAlign.center,
                  style: Get.textTheme.bodyLarge,
                ),
              ),
            ...
            SizedBox(width: 10),
            if (!_appointment.value.cancel &&
                _appointment.value.status!.order <
                    Get.find<GlobalService>().global.value.onTheWay!)
              MaterialButton(
                onPressed: () {
